...
SchemaFor200ResponseBodyApplicationJson = SDPlayerWalletGetResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _player_wallet_get_get_oapg(
        self,
...
class PlayerWalletGetGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def player_wallet_get_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def player_wallet_get_get(
        ...
        return self._player_wallet_get_get_oapg(
