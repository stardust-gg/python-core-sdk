...
# body param
SchemaForRequestBodyApplicationJson = SDGameMutateRequest


request_body_sd_game_mutate_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _game_mutate_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_game_mutate_request.serialize(body, content_type)
...
class GameMutatePut(BaseApi):
    ...
    def game_mutate_put(
        ...
        return self._game_mutate_put_oapg(
            body=body,
