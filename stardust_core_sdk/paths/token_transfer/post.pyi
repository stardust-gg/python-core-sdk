...
# body param
SchemaForRequestBodyApplicationJson = SDTokenTransferRequest


request_body_sd_token_transfer_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _token_transfer_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_token_transfer_request.serialize(body, content_type)
...
class TokenTransferPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def token_transfer_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def token_transfer_post(
        ...
        return self._token_transfer_post_oapg(
            body=body,
