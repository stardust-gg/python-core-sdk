...
# body param
SchemaForRequestBodyApplicationJson = SDPlayerCreateRequest


request_body_sd_player_create_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SDPlayerCreateResponse
...
class BaseApi(api_client.Api):
    ...
    def _player_create_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_player_create_request.serialize(body, content_type)
...
class PlayerCreatePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def player_create_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def player_create_post(
        ...
        return self._player_create_post_oapg(
            body=body,
