...
# body param
SchemaForRequestBodyApplicationJson = SDOrderBuyRequest


request_body_sd_order_buy_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _order_buy_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_order_buy_request.serialize(body, content_type)
...
class OrderBuyPost(BaseApi):
    ...
    def order_buy_post(
        ...
        return self._order_buy_post_oapg(
            body=body,
