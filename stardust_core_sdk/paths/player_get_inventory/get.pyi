...
TokenIdsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'tokenIds': typing.Union[TokenIdsSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = SDPlayerGetInventoryResponses
...
class BaseApi(api_client.Api):
    @typing.overload
    def _player_get_inventory_get_oapg(
        self,
...
class PlayerGetInventoryGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def player_get_inventory_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def player_get_inventory_get(
        ...
        return self._player_get_inventory_get_oapg(
