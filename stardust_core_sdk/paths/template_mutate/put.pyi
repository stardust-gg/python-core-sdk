...
# body param
SchemaForRequestBodyApplicationJson = SDTemplateMutateRequest


request_body_sd_template_mutate_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _template_mutate_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_template_mutate_request.serialize(body, content_type)
...
class TemplateMutatePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def template_mutate_put(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def template_mutate_put(
        ...
        return self._template_mutate_put_oapg(
            body=body,
