...
# body param
SchemaForRequestBodyApplicationJson = SDTokenBurnRequest


request_body_sd_token_burn_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _token_burn_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_token_burn_request.serialize(body, content_type)
...
class TokenBurnPost(BaseApi):
    ...
    def token_burn_post(
        ...
        return self._token_burn_post_oapg(
            body=body,
