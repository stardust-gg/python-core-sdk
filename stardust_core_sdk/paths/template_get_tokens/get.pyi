...
IncludeDeletedSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeDeleted': typing.Union[IncludeDeletedSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = SDTemplateGetTokensResponses
...
class BaseApi(api_client.Api):
    @typing.overload
    def _template_get_tokens_get_oapg(
        self,
...
class TemplateGetTokensGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def template_get_tokens_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def template_get_tokens_get(
        ...
        return self._template_get_tokens_get_oapg(
