...
# body param
SchemaForRequestBodyApplicationJson = SDTemplateCreateRequest


request_body_sd_template_create_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SDTemplateCreateResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _template_create_post_oapg(
        self,
    ...
    def _template_create_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sd_template_create_request.serialize(body, content_type)
...
class TemplateCreatePost(BaseApi):
    ...
    def template_create_post(
        ...
        return self._template_create_post_oapg(
            body=body,
