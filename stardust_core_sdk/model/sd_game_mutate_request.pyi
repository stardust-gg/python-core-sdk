...
class SDGameMutateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "news", "props", "testMode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "news", "props", "testMode", ], str]):
