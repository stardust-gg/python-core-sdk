...
class SDPlayerMutateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["playerId", "props", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["playerId", "props", ], str]):
