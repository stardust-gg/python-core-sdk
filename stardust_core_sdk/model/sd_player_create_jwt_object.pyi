...
class SDPlayerCreateJWTObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "idToken", "accessToken", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "idToken", "accessToken", ], str]):
