...
class SDPlayerWithdrawRequest(
        ...
        class properties:
            ...
            class tokenObjects(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SDPlayerWithdrawObject']:
                        return SDPlayerWithdrawObject
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SDPlayerWithdrawObject'], typing.List['SDPlayerWithdrawObject']],
                ...
                def __getitem__(self, i: int) -> 'SDPlayerWithdrawObject':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "playerId", "tokenObjects", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "playerId", "tokenObjects", ], str]):
